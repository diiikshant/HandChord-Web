...
export function MovementDiagnostics({ movement }: { movement: MovementState }) {
  const rows = [['Left hand', movement.left, 'Reverb', 'Distortion'], ['Right hand', movement.right, 'Tape Delay', 'Chorus']] as const
  return <section className="movement-panel" aria-labelledby="movement-title">
    ...
    <p>Values feed the matching connected audio controls while preserving finger-gesture chord control.</p>
